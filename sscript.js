...
async function passdata(info){
    
    for(let i=0;  i<10; i++){
    setInterval(compare(info[i].Confirmed,info[i].Deaths,info[i].Confirmed,info[i].Recovered,info[i].Active),5000);
    }
}
async function compare(confi,death,reco,active){
    /*============================================== 3 ============================================*/
